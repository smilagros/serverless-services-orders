...
curl -X PUT https://4a3plrgux1.execute-api.us-east-1.amazonaws.com/dev/update/{2} --data "{ \"text\": \"Learn Serverlesss\", \"checked\": true }"

D:\AZUMHER\Sls\services-orders-api>curl -X POST https://4a3plrgux1.execute-api.us-east-1.amazonaws.com/dev/create --data  "{\"text\": \"Learn Serverless\" }"
{"id":"1e907590-2e3c-11e9-a843-877376d39a2d","text":"Learn Serverless","checked":false,"createdAt":1549917135720,"updatedAt":1549917135720}
D:\AZUMHER\Sls\services-orders-api>curl https://4a3plrgux1.execute-api.us-east-1.amazonaws.com/dev/get/{1}
